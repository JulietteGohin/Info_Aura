...
function Option_chosen({Xind, Yind, City}) {
  ...
  return (
    <div className={styles.option}>
      ...
      <p id ="options" className={styles.option_list}>X : {Xind}, Y : {Yind}, Ville: {City}</p>
    </div>
  );
}
        ...
        <div className={styles.grid_container}>
          <div className={styles.item}>
            <div className={styles.left}>
              ...
              <Option_chosen Xind={X_INDICATORS_LIST[XIndicator]} Yind={Y_INDICATORS_LIST[YIndicator]} City={city_name} />
              <button onClick={handleButtonClick} className={styles.big_button}>Afficher graphe</button>
            </div>
          </div>
          <div className={styles.item}>
            ...
            <div className={styles.item_footer}>
              <div className={styles.padding}>
                ...
                <p>
                  ...
                  <a href="http://localhost:3000/about/" target="_blank" rel="noopener noreferrer" className={styles.row}> Lien vers le site</a>
                </p>
              </div>
            </div>
